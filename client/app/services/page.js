    ...
    <div className="overflow-x-hidden text-[#000]">
      ...
      <div className="w-[98vw] my-[2vh] mx-[1vh] py-[1vh] px-[1vw] flex flex-col justify-center  items-center">
        ...
        <p className="text-center">
          At Locora, we&rsquo;re building tools to help communities connect and
          support one another, starting with real-time local help. Here&rsquo;s
          what you can do on the platform right now:
        </p>
        <h1>📢 Post a Help Request</h1>
        <p className="text-center">
          If you need help — whether it&rsquo;s something urgent or a small task
          — you can create a Help Post describing your situation. Your request
          will be shared with people nearby who can step in.
        </p>
        ...
        <p className="text-center">
          ...
          This helps the requester know who&rsquo;s committed and builds a sense
          of accountability.
        </p>
        ...
        <p className="text-center">
          This is just the beginning. We&rsquo;re actively working on features
          like: Verified helper badges Community reputation and trust scores
          Categories for types of help (education, errands, tech, etc.)
          Group-based support (neighborhoods, campuses, clubs)
        </p>
        <h1>💡 Why This Matters</h1>
        <p className="text-center">
          Locora isn&rsquo;t just a tool — it&rsquo;s a growing movement toward
          locally driven compassion. When we make it easier to ask and easier to
